...
const DENIED_MESSAGES = [
  ...
  "I believe in you. this is taking a while but I still believe in you.",
  "still here, still rooting.",
  "you've got this. probably.",
  "you're so close. I think.",
  "the hints are getting more useful, I promise.",
  "ok something helpful is coming, I swear.",
  "read the hint. maybe twice.",
  "almost there. I feel it.",
  "that one felt different.",
  "wait — you're getting warmer.",
  "ok something is definitely happening.",
  "JK. I have absolutely no idea what you're typing.",
  "the hint is doing a lot of the work at this point.",
  "no notes. just the hint.",
  "you know this. it's in there somewhere.",
  "not giving up on you. please don't give up.",
  "the hint is your friend. trust the hint.",
  "so close.",
  "the last hint is basically a handhold.",
  "you've come so far. really.",
  "it's in the hint. genuinely.",
  "ok I would just try exactly what the hint says.",
];
