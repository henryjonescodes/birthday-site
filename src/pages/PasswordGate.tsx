...
const DENIED_MESSAGES = [
  ...
  "ok I'm about to say something helpful.",
  "read the hint. slowly.",
  "almost there. I can feel it.",
  "genuinely rooting for you.",
  "the hint is basically spelling it out at this point.",
  "no notes. just read the hint.",
  "you know this. you just have to trust it.",
  "I'm not giving up on you. please don't give up.",
  "read. the. hint.",
  "so close. I can feel it.",
  "the last hint basically hands it to you.",
  "you've come so far. don't stop now.",
  "it's in the hint. it really is.",
  "ok at this point I'd just try what the hint says.",
];
